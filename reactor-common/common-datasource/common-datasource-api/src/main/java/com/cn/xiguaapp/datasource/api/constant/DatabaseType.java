...
package com.cn.xiguaapp.datasource.api.constant;
...
public enum DatabaseType {
    ...
    mysql("com.mysql.cj.jdbc.Driver", "com.mysql.cj.jdbc.jdbc2.optional.MysqlXADataSource", "select 1", createUrlPredicate("mysql")),
