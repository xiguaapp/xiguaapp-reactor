...
import com.cn.xiguaapp.xiguaapp.java.common.core.base.SignType;
...
public enum SignUtils implements SignType {
    MD5 {
        ...
        public String createSign(String content, String key, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.MD5.sign(content, key, characterEncoding);
        }
    ...
    RSA {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.RSA.sign(content, key, characterEncoding);
        }
    ...
    RSA2 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.RSA2.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.RSA2.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA1 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.SHA1.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.SHA1.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SHA256 {
        @Override
        public String createSign(String content, String key, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.SHA256.sign(content, key, characterEncoding);
        }

        @Override
        public boolean verify(String text, String sign, String publicKey, String characterEncoding) {
            return com.cn.xiguaapp.xiguaapp.java.common.utils.encrypt.SHA256.verify(text, sign, publicKey, characterEncoding);
        }
    },
    SM3 {
        @Override
