...
public interface PayService <PC extends PayConfigStorage> {
     ...
     *
     * @param handler 消息处理器
     *                配合{@link  com.cn.xiguaapp.pay.java.common.utils.encrypt.PayService#payBack(java.util.Map, java.io.InputStream)}进行使用
     *                <p>
     *                默认使用{@link  com.cn.xiguaapp.pay.java.common.utils.encrypt.DefaultPayMessageHandler }进行实现
     */
