...
import com.cn.xiguaapp.thrid.auth.cache.AuthDefaultStateCache;
...
import com.cn.xiguaapp.thrid.auth.utils.AuthChecker;
...
public abstract class AuthDefaultRequest implements AuthRequest {
    ...
    protected String getRealState(String state) {
        if (StringUtils.isEmpty(state)) {
            state = SnowflakeIdGenerator.getInstance().toString();
        }
        // 缓存state
