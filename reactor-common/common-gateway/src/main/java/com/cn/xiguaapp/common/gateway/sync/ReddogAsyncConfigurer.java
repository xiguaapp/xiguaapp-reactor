package com.cn.xiguaapp.common.gateway.sync;
 ...
 */
@Slf4j
public class xiguaappAsyncConfigurer implements AsyncConfigurer {

    private final ThreadPoolExecutor threadPoolExecutor;

    public xiguaappAsyncConfigurer(String threadName, int poolSize) {
