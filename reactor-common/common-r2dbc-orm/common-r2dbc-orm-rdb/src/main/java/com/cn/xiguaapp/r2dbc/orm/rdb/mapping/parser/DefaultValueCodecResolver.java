...
import com.cn.xiguaapp.r2dbc.orm.rdb.codec.*;
import com.cn.xiguaapp.r2dbc.orm.rdb.mapping.EntityPropertyDescriptor;
import com.cn.xiguaapp.r2dbc.orm.rdb.mapping.annotation.Codec;
...
public class DefaultValueCodecResolver implements ValueCodecResolver {
    ...
    static {
        COMMONS.register(com.cn.xiguaapp.r2dbc.orm.rdb.mapping.annotation.DateTimeCodec.class, (field, ann) -> new DateTimeCodec(ann.format(), field.getPropertyType()));
        ...
        COMMONS.register(Date.class::isAssignableFrom, field -> new DateTimeCodec("yyyy-MM-dd HH", field.getPropertyType()));
